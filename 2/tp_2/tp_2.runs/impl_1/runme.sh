...
HD_PWD='C:/Users/hamu7/Desktop/tp_2/tp_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_UART_INTFC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_UART_INTFC.tcl -notrace
