...
HD_PWD='C:/Users/hamu7/Desktop/tp_2/tp_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_UART_INTFC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_UART_INTFC.tcl
